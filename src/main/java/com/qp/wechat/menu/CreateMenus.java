...
//
//        //创建菜单1 click button
//        ClickButton button1 = new ClickButton("活动公告", "myservice");
//        //添加一级菜单1
//        buttons.add(button1);
//
//        //创建菜单2 可以包含二级子菜单
//        SingleButton button2 = new SingleButton("我的服务");
//
//        //创建2级子菜单1，打开页面
//        ViewButton button2_1 = new ViewButton("预约报修查询", "http://qpsj.xiaomy.net/index");
...
//        String url = "http://qpsj.xiaomy.net/index";
//        //创建2级子菜单2，点击事件
//        ViewButton button2_2 = new ViewButton("个人中心", url);
//        button2.getSubButton().add(button2_2);
//
//        ViewButton button2_3 = new ViewButton("在线客服", url);
